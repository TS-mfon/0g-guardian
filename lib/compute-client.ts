      ...
      messages: [
        {
          role: "system",
          content:
            "You are a 0G Guardian transaction firewall. Return only JSON with riskScore 0-1000, verdict 1 allow 2 warn 3 block, detectedRisks array, recommendedAction, plainEnglishSummary, confidence 0-1, model, provider."
        },
        {
          role: "user",
