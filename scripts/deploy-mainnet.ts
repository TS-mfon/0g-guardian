...
async function main() {
  ...
  const env = [
    ...
    `NEXT_PUBLIC_MAINNET_AGENT_FUN_CORE_ADDRESS=${agentFun.address}`,
    `NEXT_PUBLIC_MAINNET_AGENT_ID_CONTRACT_ADDRESS=${agentId.address}`,
    `NEXT_PUBLIC_0G_CHAIN_ID=16661`,
    `NEXT_PUBLIC_0G_CHAIN_ID_HEX=0x4115`,
    `NEXT_PUBLIC_0G_RPC_URL=${rpcUrl}`,
    `NEXT_PUBLIC_MAINNET_0G_RPC_URL=${rpcUrl}`,
    "NEXT_PUBLIC_0G_EXPLORER=https://chainscan.0g.ai",
    "NEXT_PUBLIC_MAINNET_0G_EXPLORER=https://chainscan.0g.ai",
    "NEXT_PUBLIC_0G_STORAGE_INDEXER=https://indexer-storage-turbo.0g.ai",
    "NEXT_PUBLIC_MAINNET_0G_STORAGE_INDEXER=https://indexer-storage-turbo.0g.ai",
    "NEXT_PUBLIC_0G_STORAGE_SCAN=https://storagescan.0g.ai",
    "NEXT_PUBLIC_MAINNET_0G_STORAGE_SCAN=https://storagescan.0g.ai",
